...
function handlePostToolUse(input) {
  ...
  if ((toolOutput.exit_code !== undefined && toolOutput.exit_code !== 0) || (input.tool_response && input.tool_response.exit_code !== undefined && input.tool_response.exit_code !== 0)) return;

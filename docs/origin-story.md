> **Archived full origin story.** This is the complete, detailed writeup of
> where Yana Robot came from and how it relates to XiaoZhi AI Chatbot (MIT).
> The root [`README.md`](../README.md) keeps a short version of this same
> attribution — nothing here is a secret, it's just moved out of the
> repo's front page so that page can lead with what Yana Wheelbot actually
> does. See also: [Tiếng Việt](origin-story_vi.md) · [한국어](origin-story_ko.md).

---

# Yana Robot

(English | [Tiếng Việt](origin-story_vi.md) | [한국어](origin-story_ko.md))
...
<img src="mcp-based-graph.jpg" alt="Control everything via MCP" width="320">
...
- ESP-IDF v6.0 or later; v6.0.2 is the preferred stable SDK. v5.5.2 is
  ...
  [ESP-IDF 6.0 Migration Guide](esp-idf-6-migration.md) for full
...
- [Custom Board Guide](custom-board.md) — building a new board
- [MCP Protocol IoT Control Usage](mcp-usage.md)
- [MCP Protocol Interaction Flow](mcp-protocol.md)
- [WebSocket protocol](websocket.md) · [MQTT + UDP protocol](mqtt-udp.md)
- [Supported hardware](supported-boards.md) — the full inherited board list, capability list, and compatible third-party ecosystem

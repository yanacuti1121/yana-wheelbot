---
name: yana-command-refactor-rename
description: "Yana AI /refactor-rename command adapter. Rename a symbol (variable, function, class, file) across the entire codebase."
---

# Yana AI Command: /refactor-rename

Invoke this workflow explicitly as `$yana-command-refactor-rename`.

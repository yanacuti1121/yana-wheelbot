---
name: yana-command-suggest-automation
description: "Yana AI /suggest-automation command adapter. 반복 패턴 분석하여 자동화 기회 제안 (주기적 실행 권장)"
---

# Yana AI Command: /suggest-automation

Invoke this workflow explicitly as `$yana-command-suggest-automation`.

---
name: yana-command-sync-docs
description: "Yana AI /sync-docs command adapter. prompt_plan.md, spec.md, CLAUDE.md + rules/ 문서 동기화 (v7)"
---

# Yana AI Command: /sync-docs

Invoke this workflow explicitly as `$yana-command-sync-docs`.

---
name: yana-command-arch-adr
description: "Yana AI /arch-adr command adapter. Write an Architecture Decision Record documenting a significant technical decision."
---

# Yana AI Command: /arch-adr

Invoke this workflow explicitly as `$yana-command-arch-adr`.

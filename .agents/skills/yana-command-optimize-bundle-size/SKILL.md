---
name: yana-command-optimize-bundle-size
description: "Yana AI /optimize-bundle-size command adapter. Reduce and optimize bundle sizes"
---

# Yana AI Command: /optimize-bundle-size

Invoke this workflow explicitly as `$yana-command-optimize-bundle-size`.

---
name: yana-command-csp
description: "Yana AI /csp command adapter. Generate Content Security Policy headers for a web application."
---

# Yana AI Command: /csp

Invoke this workflow explicitly as `$yana-command-csp`.

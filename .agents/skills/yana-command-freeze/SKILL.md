---
name: yana-command-freeze
description: "Yana AI /freeze command adapter. Restrict all file edits (Write/Edit/MultiEdit) to one or more directories/files/regex patterns for the rest of this session — a hard, hook-enforced boundary, not a self-reported convention. Usage: /freeze <path-or-pattern> [path-or-pattern...]"
---

# Yana AI Command: /freeze

Invoke this workflow explicitly as `$yana-command-freeze`.

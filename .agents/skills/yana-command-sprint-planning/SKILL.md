---
name: yana-command-sprint-planning
description: "Yana AI /sprint-planning command adapter. Plan and organize sprint workflows"
---

# Yana AI Command: /sprint-planning

Invoke this workflow explicitly as `$yana-command-sprint-planning`.

---
name: yana-command-fact-check
description: "Yana AI /fact-check command adapter. Proactively verify a claim before stating it. Shows evidence inline and rates confidence. Distinct from Truth Gate (reactive) — /fact-check is proactive, invoked before you commit to a statement."
---

# Yana AI Command: /fact-check

Invoke this workflow explicitly as `$yana-command-fact-check`.

---
name: yana-command-learn
description: "Yana AI /learn command adapter. 교훈 기록 + 자동화 제안 (v6 - suggest-automation 통합)"
---

# Yana AI Command: /learn

Invoke this workflow explicitly as `$yana-command-learn`.

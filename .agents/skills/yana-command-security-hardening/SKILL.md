---
name: yana-command-security-hardening
description: "Yana AI /security-hardening command adapter. Harden application security configuration"
---

# Yana AI Command: /security-hardening

Invoke this workflow explicitly as `$yana-command-security-hardening`.

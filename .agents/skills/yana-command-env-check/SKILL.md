---
name: yana-command-env-check
description: "Yana AI /env-check command adapter. Compare .env vs .env.example to find missing keys, extra keys, and empty values"
---

# Yana AI Command: /env-check

Invoke this workflow explicitly as `$yana-command-env-check`.

---
name: yana-command-ultra-think
description: "Yana AI /ultra-think command adapter. Deep analysis and problem solving mode"
---

# Yana AI Command: /ultra-think

Invoke this workflow explicitly as `$yana-command-ultra-think`.

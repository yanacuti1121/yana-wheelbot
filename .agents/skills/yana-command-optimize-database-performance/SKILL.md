---
name: yana-command-optimize-database-performance
description: "Yana AI /optimize-database-performance command adapter. Optimize database queries and performance"
---

# Yana AI Command: /optimize-database-performance

Invoke this workflow explicitly as `$yana-command-optimize-database-performance`.

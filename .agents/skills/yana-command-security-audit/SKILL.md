---
name: yana-command-security-audit
description: "Yana AI /security-audit command adapter. Perform comprehensive security assessment"
---

# Yana AI Command: /security-audit

Invoke this workflow explicitly as `$yana-command-security-audit`.

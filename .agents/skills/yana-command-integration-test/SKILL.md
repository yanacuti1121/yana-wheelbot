---
name: yana-command-integration-test
description: "Yana AI /integration-test command adapter. Generate integration tests for a module, testing real interactions between components."
---

# Yana AI Command: /integration-test

Invoke this workflow explicitly as `$yana-command-integration-test`.

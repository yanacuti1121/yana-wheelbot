---
name: yana-command-arch-diagram
description: "Yana AI /arch-diagram command adapter. Generate Mermaid diagrams from codebase analysis or description."
---

# Yana AI Command: /arch-diagram

Invoke this workflow explicitly as `$yana-command-arch-diagram`.

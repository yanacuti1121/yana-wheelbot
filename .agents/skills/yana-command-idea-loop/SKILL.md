---
name: yana-command-idea-loop
description: "Yana AI /idea-loop command adapter. Trợ lý điều hành cá nhân của anh Tâm — briefing, bộ nhớ riêng, ưu tiên ngày, risk radar. Tự chạy khi mở session. Usage: /idea-loop"
---

# Yana AI Command: /idea-loop

Invoke this workflow explicitly as `$yana-command-idea-loop`.

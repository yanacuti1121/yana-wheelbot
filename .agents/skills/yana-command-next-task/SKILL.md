---
name: yana-command-next-task
description: "Yana AI /next-task command adapter. 다음 작업 추천 (v6)"
---

# Yana AI Command: /next-task

Invoke this workflow explicitly as `$yana-command-next-task`.

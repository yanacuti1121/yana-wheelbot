---
name: yana-command-test-coverage
description: "Yana AI /test-coverage command adapter. Analyze and report test coverage"
---

# Yana AI Command: /test-coverage

Invoke this workflow explicitly as `$yana-command-test-coverage`.

---
name: yana-command-verify
description: "Yana AI /verify command adapter. Full system health check — git state, hook syntax, hook tests, drift report. Shows actual command output. Usage: /verify"
---

# Yana AI Command: /verify

Invoke this workflow explicitly as `$yana-command-verify`.

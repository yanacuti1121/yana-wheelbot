---
name: yana-command-status
description: "Yana AI /status command adapter. Project health overview — renders a structured status card from TODO.md, recent git history, open PRs, and PRD open questions. Usage: /status"
---

# Yana AI Command: /status

Invoke this workflow explicitly as `$yana-command-status`.

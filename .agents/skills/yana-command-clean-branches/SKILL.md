---
name: yana-command-clean-branches
description: "Yana AI /clean-branches command adapter. Clean up merged and stale git branches"
---

# Yana AI Command: /clean-branches

Invoke this workflow explicitly as `$yana-command-clean-branches`.

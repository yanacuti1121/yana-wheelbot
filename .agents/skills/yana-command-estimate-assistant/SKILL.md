---
name: yana-command-estimate-assistant
description: "Yana AI /estimate-assistant command adapter. Generate accurate project time estimates"
---

# Yana AI Command: /estimate-assistant

Invoke this workflow explicitly as `$yana-command-estimate-assistant`.

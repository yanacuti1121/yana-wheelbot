---
name: yana-command-smart-debug
description: "Yana AI /smart-debug command adapter. Debug complex issues using specialized debugging agents:"
---

# Yana AI Command: /smart-debug

Invoke this workflow explicitly as `$yana-command-smart-debug`.

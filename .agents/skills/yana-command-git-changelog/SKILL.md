---
name: yana-command-git-changelog
description: "Yana AI /git-changelog command adapter. Generate a changelog from git history since the last tag or a specified reference point."
---

# Yana AI Command: /git-changelog

Invoke this workflow explicitly as `$yana-command-git-changelog`.

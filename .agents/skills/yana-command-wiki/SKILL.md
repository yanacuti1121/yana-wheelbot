---
name: yana-command-wiki
description: "Yana AI /wiki command adapter. Generate or refresh static wiki docs from the gitnexus knowledge graph and commit to docs/wiki/. Agents read docs/wiki/ instead of scanning code — saves tokens significantly."
---

# Yana AI Command: /wiki

Invoke this workflow explicitly as `$yana-command-wiki`.

---
name: yana-command-wrap-up
description: "Yana AI /wrap-up command adapter. End the current session with a structured summary and memory update."
---

# Yana AI Command: /wrap-up

Invoke this workflow explicitly as `$yana-command-wrap-up`.

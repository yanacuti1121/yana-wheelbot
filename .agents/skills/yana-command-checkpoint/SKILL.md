---
name: yana-command-checkpoint
description: "Yana AI /checkpoint command adapter. Save-and-commit checkpoint — verifies docs are updated, runs available linting/tests, then creates a WIP commit so no work is lost before pausing. Usage: /checkpoint [optional: short description of current state]"
---

# Yana AI Command: /checkpoint

Invoke this workflow explicitly as `$yana-command-checkpoint`.

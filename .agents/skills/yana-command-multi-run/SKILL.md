---
name: yana-command-multi-run
description: "Yana AI /multi-run command adapter. Chạy nhiều agents song song cho các task độc lập. Luật chặt hơn single-agent mode. Usage: /multi-run <task1> | <task2> | <task3>"
---

# Yana AI Command: /multi-run

Invoke this workflow explicitly as `$yana-command-multi-run`.

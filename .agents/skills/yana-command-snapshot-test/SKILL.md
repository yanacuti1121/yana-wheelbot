---
name: yana-command-snapshot-test
description: "Yana AI /snapshot-test command adapter. Generate snapshot tests for UI components or serializable outputs."
---

# Yana AI Command: /snapshot-test

Invoke this workflow explicitly as `$yana-command-snapshot-test`.

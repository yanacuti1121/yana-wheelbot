---
name: yana-command-tdd-refactor
description: "Yana AI /tdd-refactor command adapter. Refactor code with confidence using comprehensive test safety net:"
---

# Yana AI Command: /tdd-refactor

Invoke this workflow explicitly as `$yana-command-tdd-refactor`.

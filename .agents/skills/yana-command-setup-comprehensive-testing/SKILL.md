---
name: yana-command-setup-comprehensive-testing
description: "Yana AI /setup-comprehensive-testing command adapter. Setup complete testing infrastructure"
---

# Yana AI Command: /setup-comprehensive-testing

Invoke this workflow explicitly as `$yana-command-setup-comprehensive-testing`.

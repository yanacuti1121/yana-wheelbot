---
name: yana-command-incident-response
description: "Yana AI /incident-response command adapter. Respond to production incidents with coordinated agent expertise for rapid resolution:"
---

# Yana AI Command: /incident-response

Invoke this workflow explicitly as `$yana-command-incident-response`.

---
name: yana-command-deps-upgrade
description: "Yana AI /deps-upgrade command adapter. You are a dependency management expert specializing in safe, incremental upgrades of project dependencies. Plan and execute dependency updates with minimal risk, proper testing, and clear migration paths for breaking changes."
---

# Yana AI Command: /deps-upgrade

Invoke this workflow explicitly as `$yana-command-deps-upgrade`.

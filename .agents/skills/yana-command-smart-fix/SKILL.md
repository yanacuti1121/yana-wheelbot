---
name: yana-command-smart-fix
description: "Yana AI /smart-fix command adapter. Intelligently fix the issue using automatic agent selection with explicit Task tool invocations:"
---

# Yana AI Command: /smart-fix

Invoke this workflow explicitly as `$yana-command-smart-fix`.

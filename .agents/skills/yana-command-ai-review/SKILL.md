---
name: yana-command-ai-review
description: "Yana AI /ai-review command adapter. Perform a specialized AI/ML code review for: $ARGUMENTS"
---

# Yana AI Command: /ai-review

Invoke this workflow explicitly as `$yana-command-ai-review`.

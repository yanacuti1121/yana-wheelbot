---
name: yana-command-review
description: "Yana AI /review command adapter. Multi-agent code review — architectural drift check, test coverage audit, and implementation quality review scoped to recently changed files. Usage: /review [optional: branch or file path scope]"
---

# Yana AI Command: /review

Invoke this workflow explicitly as `$yana-command-review`.

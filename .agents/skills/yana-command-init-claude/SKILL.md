---
name: yana-command-init-claude
description: "Yana AI /init-claude command adapter. Generate a detailed, project-specific CLAUDE.md by interviewing you about your stack, architecture, and conventions. Run once after /start to replace the generic template with real project context. Usage: /init-claude"
---

# Yana AI Command: /init-claude

Invoke this workflow explicitly as `$yana-command-init-claude`.

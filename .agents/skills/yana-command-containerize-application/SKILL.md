---
name: yana-command-containerize-application
description: "Yana AI /containerize-application command adapter. Containerize application for deployment"
---

# Yana AI Command: /containerize-application

Invoke this workflow explicitly as `$yana-command-containerize-application`.

---
name: yana-command-monitor-setup
description: "Yana AI /monitor-setup command adapter. You are a monitoring and observability expert specializing in implementing comprehensive monitoring solutions. Set up metrics collection, distributed tracing, log aggregation, and create insightful dashboards that provide full visibility into system health and performance."
---

# Yana AI Command: /monitor-setup

Invoke this workflow explicitly as `$yana-command-monitor-setup`.

---
name: yana-command-audit
description: "Yana AI /audit command adapter. Lightweight system audit using 5 quality-control agents (gardener, firewall, token-guard, doctor, router). Reports issues without making changes. Run before /fix."
---

# Yana AI Command: /audit

Invoke this workflow explicitly as `$yana-command-audit`.

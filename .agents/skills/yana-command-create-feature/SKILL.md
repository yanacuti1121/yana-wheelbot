---
name: yana-command-create-feature
description: "Yana AI /create-feature command adapter. Scaffold new feature with boilerplate code"
---

# Yana AI Command: /create-feature

Invoke this workflow explicitly as `$yana-command-create-feature`.

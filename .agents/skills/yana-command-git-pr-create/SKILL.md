---
name: yana-command-git-pr-create
description: "Yana AI /git-pr-create command adapter. Create a pull request with a structured description based on the current branch's changes."
---

# Yana AI Command: /git-pr-create

Invoke this workflow explicitly as `$yana-command-git-pr-create`.

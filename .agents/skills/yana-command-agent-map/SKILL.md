---
name: yana-command-agent-map
description: "Yana AI /agent-map command adapter. Print a readable map of all 19 agents — what each does, when to use it, and which agents should NOT be combined. Reads from agent-routing-map.json and core/agents/. No arguments needed."
---

# Yana AI Command: /agent-map

Invoke this workflow explicitly as `$yana-command-agent-map`.

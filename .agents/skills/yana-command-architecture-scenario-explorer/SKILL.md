---
name: yana-command-architecture-scenario-explorer
description: "Yana AI /architecture-scenario-explorer command adapter. Explore architectural decisions through systematic scenario analysis with trade-off evaluation and future-proofing assessment."
---

# Yana AI Command: /architecture-scenario-explorer

Invoke this workflow explicitly as `$yana-command-architecture-scenario-explorer`.

---
name: yana-command-fix-issue
description: "Yana AI /fix-issue command adapter. Identify and resolve code issues"
---

# Yana AI Command: /fix-issue

Invoke this workflow explicitly as `$yana-command-fix-issue`.

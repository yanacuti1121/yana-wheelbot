---
name: yana-command-prime
description: "Yana AI /prime command adapter. Enhanced AI mode for complex tasks"
---

# Yana AI Command: /prime

Invoke this workflow explicitly as `$yana-command-prime`.

---
name: yana-command-commit-push-pr
description: "Yana AI /commit-push-pr command adapter. 검증 완료 후 커밋 & PR & 머지 + MCP 알림 (v6)"
---

# Yana AI Command: /commit-push-pr

Invoke this workflow explicitly as `$yana-command-commit-push-pr`.

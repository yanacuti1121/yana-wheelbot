---
name: yana-command-create-architecture-documentation
description: "Yana AI /create-architecture-documentation command adapter. Generate comprehensive architecture documentation"
---

# Yana AI Command: /create-architecture-documentation

Invoke this workflow explicitly as `$yana-command-create-architecture-documentation`.

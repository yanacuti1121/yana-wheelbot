---
name: yana-command-budget-mode
description: "Yana AI /budget-mode command adapter. Toggle Budget Mode for the current project. Budget Mode tightens cost-guard rules — see CLAUDE.md for the full rule set. Usage — /budget-mode [on|off|status]"
---

# Yana AI Command: /budget-mode

Invoke this workflow explicitly as `$yana-command-budget-mode`.

---
name: yana-command-release
description: "Yana AI /release command adapter. Pre-release quality pass — checks backlog readiness, runs QA, updates docs, and verifies the CI/CD pipeline before shipping. Usage: /release [optional: version label e.g. v1.2.0]"
---

# Yana AI Command: /release

Invoke this workflow explicitly as `$yana-command-release`.

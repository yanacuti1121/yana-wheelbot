---
name: yana-command-deploy-checklist
description: "Yana AI /deploy-checklist command adapter. Generate deployment configuration and checklist for: $ARGUMENTS"
---

# Yana AI Command: /deploy-checklist

Invoke this workflow explicitly as `$yana-command-deploy-checklist`.

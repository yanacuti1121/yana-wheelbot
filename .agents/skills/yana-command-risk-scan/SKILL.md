---
name: yana-command-risk-scan
description: "Yana AI /risk-scan command adapter. Scan current session plan for high-risk actions before executing — score each planned action and flag anything CRITICAL or HIGH before it runs. Usage: /risk-scan [file or plan description]"
---

# Yana AI Command: /risk-scan

Invoke this workflow explicitly as `$yana-command-risk-scan`.

---
name: yana-command-git-commit
description: "Yana AI /git-commit command adapter. Analyze the currently staged changes (git diff --cached) and generate a conventional commit message."
---

# Yana AI Command: /git-commit

Invoke this workflow explicitly as `$yana-command-git-commit`.

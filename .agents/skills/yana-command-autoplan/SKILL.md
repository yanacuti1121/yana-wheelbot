---
name: yana-command-autoplan
description: "Yana AI /autoplan command adapter. Run the full plan-review pipeline against one plan or feature idea — technical red-team, business/PMF review, and structural design review, in sequence — then merge the three verdicts into one consolidated recommendation. Usage: /autoplan <plan description or path>"
---

# Yana AI Command: /autoplan

Invoke this workflow explicitly as `$yana-command-autoplan`.

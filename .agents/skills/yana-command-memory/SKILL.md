---
name: yana-command-memory
description: "Yana AI /memory command adapter. Search L1 and L2 memory. Usage: /memory [keyword] [--type TYPE] [--scope SCOPE] [--confidence LEVEL] [--tag TAG] [--expired] [--all] [--l2] [--l2-only] [--semantic] [--top N]"
---

# Yana AI Command: /memory

Invoke this workflow explicitly as `$yana-command-memory`.

---
name: yana-command-arch-plan
description: "Yana AI /arch-plan command adapter. Create a structured implementation plan for the requested feature or change."
---

# Yana AI Command: /arch-plan

Invoke this workflow explicitly as `$yana-command-arch-plan`.

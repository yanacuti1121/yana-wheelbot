---
name: yana-command-refactor-cleanup
description: "Yana AI /refactor-cleanup command adapter. Find and remove dead code, unused imports, and unreachable branches."
---

# Yana AI Command: /refactor-cleanup

Invoke this workflow explicitly as `$yana-command-refactor-cleanup`.

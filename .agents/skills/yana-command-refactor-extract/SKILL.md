---
name: yana-command-refactor-extract
description: "Yana AI /refactor-extract command adapter. Extract a function, component, or module from existing code into its own unit."
---

# Yana AI Command: /refactor-extract

Invoke this workflow explicitly as `$yana-command-refactor-extract`.

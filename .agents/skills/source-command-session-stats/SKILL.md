---
name: "source-command-session-stats"
description: "Show hook fires, blocks, risk score history, and trust score for this session"
---

# source-command-session-stats

Use this skill when the user asks to run the migrated source command `session-stats`.
...
state   = Path(project) / '.Codex' / 'state'

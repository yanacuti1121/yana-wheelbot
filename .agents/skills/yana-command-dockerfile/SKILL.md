---
name: yana-command-dockerfile
description: "Yana AI /dockerfile command adapter. Generate an optimized Dockerfile for the current project."
---

# Yana AI Command: /dockerfile

Invoke this workflow explicitly as `$yana-command-dockerfile`.

---
name: yana-command-security-scan
description: "Yana AI /security-scan command adapter. Run a security scan on the current codebase using the Red/Blue/Purple Team skill pack. Requires ownership confirmation."
---

# Yana AI Command: /security-scan

Invoke this workflow explicitly as `$yana-command-security-scan`.

---
name: yana-command-session
description: "Yana AI /session command adapter. Manage Yana AI L2 Session Memory — add, search, and clear session-scoped facts. Usage: /session [keyword] | /session --add | /session --clear | /session --all"
---

# Yana AI Command: /session

Invoke this workflow explicitly as `$yana-command-session`.

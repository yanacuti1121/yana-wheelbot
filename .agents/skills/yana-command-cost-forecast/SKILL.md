---
name: yana-command-cost-forecast
description: "Yana AI /cost-forecast command adapter. Estimate token cost before starting a large task — analyze scope, estimate tool calls, project token usage and USD cost. Usage: /cost-forecast [task description]"
---

# Yana AI Command: /cost-forecast

Invoke this workflow explicitly as `$yana-command-cost-forecast`.

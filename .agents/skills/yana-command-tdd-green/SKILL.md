---
name: yana-command-tdd-green
description: "Yana AI /tdd-green command adapter. Implement minimal code to make failing tests pass in TDD green phase:"
---

# Yana AI Command: /tdd-green

Invoke this workflow explicitly as `$yana-command-tdd-green`.

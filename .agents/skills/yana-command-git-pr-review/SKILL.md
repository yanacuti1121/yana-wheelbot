---
name: yana-command-git-pr-review
description: "Yana AI /git-pr-review command adapter. Review a pull request by number: fetch the diff, analyze changes, and post review comments."
---

# Yana AI Command: /git-pr-review

Invoke this workflow explicitly as `$yana-command-git-pr-review`.

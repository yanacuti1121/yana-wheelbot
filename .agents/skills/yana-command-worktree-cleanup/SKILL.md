---
name: yana-command-worktree-cleanup
description: "Yana AI /worktree-cleanup command adapter. PR 완료 후 Git Worktree 정리 (v6)"
---

# Yana AI Command: /worktree-cleanup

Invoke this workflow explicitly as `$yana-command-worktree-cleanup`.

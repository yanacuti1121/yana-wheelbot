---
name: yana-command-refactor-simplify
description: "Yana AI /refactor-simplify command adapter. Simplify code to improve readability and maintainability."
---

# Yana AI Command: /refactor-simplify

Invoke this workflow explicitly as `$yana-command-refactor-simplify`.

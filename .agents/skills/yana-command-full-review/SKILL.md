---
name: yana-command-full-review
description: "Yana AI /full-review command adapter. Perform a comprehensive review using multiple specialized agents with explicit Task tool invocations:"
---

# Yana AI Command: /full-review

Invoke this workflow explicitly as `$yana-command-full-review`.

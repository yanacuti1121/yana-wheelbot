---
name: yana-command-verify-pack
description: "Yana AI /verify-pack command adapter. Verify the Claude Code template pack integrity: agents, commands, hooks, routing map, lock files, and hook health. Usage: /verify-pack"
---

# Yana AI Command: /verify-pack

Invoke this workflow explicitly as `$yana-command-verify-pack`.

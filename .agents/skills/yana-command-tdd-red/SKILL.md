---
name: yana-command-tdd-red
description: "Yana AI /tdd-red command adapter. Write comprehensive failing tests following TDD red phase principles:"
---

# Yana AI Command: /tdd-red

Invoke this workflow explicitly as `$yana-command-tdd-red`.

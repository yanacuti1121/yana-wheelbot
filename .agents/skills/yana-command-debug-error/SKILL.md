---
name: yana-command-debug-error
description: "Yana AI /debug-error command adapter. Systematically debug and fix errors"
---

# Yana AI Command: /debug-error

Invoke this workflow explicitly as `$yana-command-debug-error`.

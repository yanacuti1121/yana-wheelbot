---
name: yana-command-monitor
description: "Yana AI /monitor command adapter. Set up monitoring, alerting, and observability for the application."
---

# Yana AI Command: /monitor

Invoke this workflow explicitly as `$yana-command-monitor`.

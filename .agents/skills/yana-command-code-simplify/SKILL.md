---
name: yana-command-code-simplify
description: "Yana AI /code-simplify command adapter. Reduce code complexity without changing behaviour. Finds dead code, over-abstraction, redundant logic, and unnecessary indirection. Usage: /code-simplify [file or directory]"
---

# Yana AI Command: /code-simplify

Invoke this workflow explicitly as `$yana-command-code-simplify`.

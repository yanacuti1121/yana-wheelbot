---
name: yana-command-performance-audit
description: "Yana AI /performance-audit command adapter. Audit application performance metrics"
---

# Yana AI Command: /performance-audit

Invoke this workflow explicitly as `$yana-command-performance-audit`.

---
name: yana-command-test-fix
description: "Yana AI /test-fix command adapter. Diagnose and fix failing tests in the project."
---

# Yana AI Command: /test-fix

Invoke this workflow explicitly as `$yana-command-test-fix`.

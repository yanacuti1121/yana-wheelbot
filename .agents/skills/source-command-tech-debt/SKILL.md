---
name: "source-command-tech-debt"
description: "Scan codebase for TODO, FIXME, HACK, XXX markers and output a prioritized debt report"
---

# source-command-tech-debt

Use this skill when the user asks to run the migrated source command `tech-debt`.

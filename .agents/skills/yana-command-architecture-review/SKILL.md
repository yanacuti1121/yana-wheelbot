---
name: yana-command-architecture-review
description: "Yana AI /architecture-review command adapter. Review and improve system architecture"
---

# Yana AI Command: /architecture-review

Invoke this workflow explicitly as `$yana-command-architecture-review`.

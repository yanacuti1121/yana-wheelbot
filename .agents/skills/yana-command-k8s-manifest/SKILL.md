---
name: yana-command-k8s-manifest
description: "Yana AI /k8s-manifest command adapter. Generate Kubernetes manifests for deploying the current application."
---

# Yana AI Command: /k8s-manifest

Invoke this workflow explicitly as `$yana-command-k8s-manifest`.

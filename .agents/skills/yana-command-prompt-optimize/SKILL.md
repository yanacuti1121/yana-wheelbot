---
name: yana-command-prompt-optimize
description: "Yana AI /prompt-optimize command adapter. Optimize the following prompt for better AI model performance: $ARGUMENTS"
---

# Yana AI Command: /prompt-optimize

Invoke this workflow explicitly as `$yana-command-prompt-optimize`.

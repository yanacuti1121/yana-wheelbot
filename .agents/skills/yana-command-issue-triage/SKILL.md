---
name: yana-command-issue-triage
description: "Yana AI /issue-triage command adapter. Triage and prioritize issues effectively"
---

# Yana AI Command: /issue-triage

Invoke this workflow explicitly as `$yana-command-issue-triage`.

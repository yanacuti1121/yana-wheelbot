---
name: yana-command-generate-test-cases
description: "Yana AI /generate-test-cases command adapter. Generate comprehensive test cases automatically"
---

# Yana AI Command: /generate-test-cases

Invoke this workflow explicitly as `$yana-command-generate-test-cases`.

---
name: yana-command-multi-agent-review
description: "Yana AI /multi-agent-review command adapter. Perform comprehensive multi-agent code review with specialized reviewers:"
---

# Yana AI Command: /multi-agent-review

Invoke this workflow explicitly as `$yana-command-multi-agent-review`.

---
name: yana-command-project-health-check
description: "Yana AI /project-health-check command adapter. Analyze overall project health and metrics"
---

# Yana AI Command: /project-health-check

Invoke this workflow explicitly as `$yana-command-project-health-check`.

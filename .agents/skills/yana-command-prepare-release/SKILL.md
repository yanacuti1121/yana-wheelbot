---
name: yana-command-prepare-release
description: "Yana AI /prepare-release command adapter. Prepare and validate release packages"
---

# Yana AI Command: /prepare-release

Invoke this workflow explicitly as `$yana-command-prepare-release`.

---
name: yana-command-hook-review
description: "Yana AI /hook-review command adapter. Hook lifecycle review — kiểm tra toàn bộ hook còn hiệu quả, có test, đúng version. Chạy định kỳ 3-6 tháng hoặc sau major Claude Code release. Usage: /hook-review"
---

# Yana AI Command: /hook-review

Invoke this workflow explicitly as `$yana-command-hook-review`.

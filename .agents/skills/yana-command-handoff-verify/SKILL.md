---
name: yana-command-handoff-verify
description: "Yana AI /handoff-verify command adapter. 빌드/테스트/린트를 한 번에 자동 검증합니다."
---

# Yana AI Command: /handoff-verify

Invoke this workflow explicitly as `$yana-command-handoff-verify`.

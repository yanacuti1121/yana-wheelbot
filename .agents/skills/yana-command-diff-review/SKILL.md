---
name: yana-command-diff-review
description: "Yana AI /diff-review command adapter. Quick safety review of current git diff before commit — checks for bugs, security risks, scope violations, and rogue files. Usage: /diff-review"
---

# Yana AI Command: /diff-review

Invoke this workflow explicitly as `$yana-command-diff-review`.

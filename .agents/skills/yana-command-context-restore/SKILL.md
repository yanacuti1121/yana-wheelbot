---
name: yana-command-context-restore
description: "Yana AI /context-restore command adapter. Restore saved project context for agent coordination:"
---

# Yana AI Command: /context-restore

Invoke this workflow explicitly as `$yana-command-context-restore`.

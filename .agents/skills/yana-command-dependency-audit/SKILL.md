---
name: yana-command-dependency-audit
description: "Yana AI /dependency-audit command adapter. Audit dependencies for security vulnerabilities"
---

# Yana AI Command: /dependency-audit

Invoke this workflow explicitly as `$yana-command-dependency-audit`.

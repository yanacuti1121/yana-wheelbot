---
name: yana-command-session-stats
description: "Yana AI /session-stats command adapter. Show hook fires, blocks, risk score history, and trust score for this session"
---

# Yana AI Command: /session-stats

Invoke this workflow explicitly as `$yana-command-session-stats`.

---
name: yana-command-add-package
description: "Yana AI /add-package command adapter. Add and configure new project dependencies"
---

# Yana AI Command: /add-package

Invoke this workflow explicitly as `$yana-command-add-package`.

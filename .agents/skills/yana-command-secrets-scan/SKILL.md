---
name: yana-command-secrets-scan
description: "Yana AI /secrets-scan command adapter. Scan the codebase for leaked secrets, API keys, tokens, and credentials."
---

# Yana AI Command: /secrets-scan

Invoke this workflow explicitly as `$yana-command-secrets-scan`.

---
name: yana-command-tech-debt
description: "Yana AI /tech-debt command adapter. Scan codebase for TODO, FIXME, HACK, XXX markers and output a prioritized debt report"
---

# Yana AI Command: /tech-debt

Invoke this workflow explicitly as `$yana-command-tech-debt`.

---
name: yana-command-challenge
description: "Yana AI /challenge command adapter. Red-team a feature idea before it enters PRD.md. Opus plays devil's advocate — attacks the proposal on four fronts (logic, security, UX, scalability) to surface blind spots while changes are still cheap. Usage: /challenge <feature or idea>"
---

# Yana AI Command: /challenge

Invoke this workflow explicitly as `$yana-command-challenge`.

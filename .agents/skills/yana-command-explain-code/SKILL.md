---
name: yana-command-explain-code
description: "Yana AI /explain-code command adapter. Analyze and explain code functionality"
---

# Yana AI Command: /explain-code

Invoke this workflow explicitly as `$yana-command-explain-code`.

---
name: yana-command-data-pipeline
description: "Yana AI /data-pipeline command adapter. Design and implement a scalable data pipeline for: $ARGUMENTS"
---

# Yana AI Command: /data-pipeline

Invoke this workflow explicitly as `$yana-command-data-pipeline`.

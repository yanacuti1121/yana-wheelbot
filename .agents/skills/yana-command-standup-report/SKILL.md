---
name: yana-command-standup-report
description: "Yana AI /standup-report command adapter. Generate daily standup reports"
---

# Yana AI Command: /standup-report

Invoke this workflow explicitly as `$yana-command-standup-report`.

---
name: yana-command-rollback
description: "Yana AI /rollback command adapter. Rollback working tree to a saved checkpoint — list available checkpoints, preview diff, apply rollback with confirmation. Usage: /rollback [--list | --id cp-XYZ | --dry-run]"
---

# Yana AI Command: /rollback

Invoke this workflow explicitly as `$yana-command-rollback`.

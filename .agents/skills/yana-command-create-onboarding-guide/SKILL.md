---
name: yana-command-create-onboarding-guide
description: "Yana AI /create-onboarding-guide command adapter. Create developer onboarding guide"
---

# Yana AI Command: /create-onboarding-guide

Invoke this workflow explicitly as `$yana-command-create-onboarding-guide`.

---
name: yana-command-optimize-build
description: "Yana AI /optimize-build command adapter. Optimize build processes and speed"
---

# Yana AI Command: /optimize-build

Invoke this workflow explicitly as `$yana-command-optimize-build`.

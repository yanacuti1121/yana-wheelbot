---
name: yana-command-issue
description: "Yana AI /issue command adapter. Please analyze and fix the GitHub issue: $ARGUMENTS."
---

# Yana AI Command: /issue

Invoke this workflow explicitly as `$yana-command-issue`.

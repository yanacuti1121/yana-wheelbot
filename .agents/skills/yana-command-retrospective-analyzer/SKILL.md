---
name: yana-command-retrospective-analyzer
description: "Yana AI /retrospective-analyzer command adapter. Analyze team retrospectives for insights"
---

# Yana AI Command: /retrospective-analyzer

Invoke this workflow explicitly as `$yana-command-retrospective-analyzer`.

---
name: yana-command-refactor-clean
description: "Yana AI /refactor-clean command adapter. Safely identify and remove dead code with test verification"
---

# Yana AI Command: /refactor-clean

Invoke this workflow explicitly as `$yana-command-refactor-clean`.

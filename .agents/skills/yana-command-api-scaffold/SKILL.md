---
name: yana-command-api-scaffold
description: "Yana AI /api-scaffold command adapter. You are an API development expert specializing in creating production-ready, scalable REST APIs with modern frameworks. Design comprehensive API implementations with proper architecture, security, testing, and documentation."
---

# Yana AI Command: /api-scaffold

Invoke this workflow explicitly as `$yana-command-api-scaffold`.

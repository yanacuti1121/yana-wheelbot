---
name: yana-command-sync-template
description: "Yana AI /sync-template command adapter. Sync the .claude template from upstream while preserving local-only project customizations. Usage: /sync-template"
---

# Yana AI Command: /sync-template

Invoke this workflow explicitly as `$yana-command-sync-template`.

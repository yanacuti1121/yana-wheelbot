---
name: yana-command-git-worktree
description: "Yana AI /git-worktree command adapter. Set up git worktrees for parallel development on multiple branches simultaneously."
---

# Yana AI Command: /git-worktree

Invoke this workflow explicitly as `$yana-command-git-worktree`.

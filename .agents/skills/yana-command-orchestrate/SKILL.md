---
name: yana-command-orchestrate
description: "Yana AI /orchestrate command adapter. Orchestrate a multi-agent task — analyzes dependencies, builds a wave execution plan, coordinates with the project manager, creates a feature branch, and runs specialist agents in parallel and sequential waves. Usage: /orchestrate <task description>"
---

# Yana AI Command: /orchestrate

Invoke this workflow explicitly as `$yana-command-orchestrate`.

---
name: yana-command-doc-api
description: "Yana AI /doc-api command adapter. Generate API documentation from code"
---

# Yana AI Command: /doc-api

Invoke this workflow explicitly as `$yana-command-doc-api`.

---
name: yana-command-incremental-feature-build
description: "Yana AI /incremental-feature-build command adapter. Systematic approach for building complex features incrementally, preventing premature completion and ensuring comprehensive functionality through structured feature tracking."
---

# Yana AI Command: /incremental-feature-build

Invoke this workflow explicitly as `$yana-command-incremental-feature-build`.

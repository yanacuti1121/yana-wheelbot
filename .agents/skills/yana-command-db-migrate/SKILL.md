---
name: yana-command-db-migrate
description: "Yana AI /db-migrate command adapter. You are a database migration expert specializing in zero-downtime deployments, data integrity, and multi-database environments. Create comprehensive migration scripts with rollback strategies, validation checks, and performance optimization."
---

# Yana AI Command: /db-migrate

Invoke this workflow explicitly as `$yana-command-db-migrate`.

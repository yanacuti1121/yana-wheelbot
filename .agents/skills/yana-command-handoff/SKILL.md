---
name: yana-command-handoff
description: "Yana AI /handoff command adapter. Create a handoff document — capturing current state, open tasks, and root-cause context so work can be resumed by another agent, another Claude session, or a human teammate. Usage: /handoff [topic]"
---

# Yana AI Command: /handoff

Invoke this workflow explicitly as `$yana-command-handoff`.

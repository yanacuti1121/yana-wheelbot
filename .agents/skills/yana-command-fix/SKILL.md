---
name: yana-command-fix
description: "Yana AI /fix command adapter. Apply minimal patches based on the latest /audit report. Requires explicit human approval before each change."
---

# Yana AI Command: /fix

Invoke this workflow explicitly as `$yana-command-fix`.
